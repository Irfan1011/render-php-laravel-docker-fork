            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-center d-flex align-items-center justify-content-center"><img src="{{ asset('uploads/Employee_Photo/'.$EmployeeUserRole->photo) }}" height="300" width="300"/></div>
                        <div class="col-sm-6 text-center d-flex flex-column align-items-center mt-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="row">: {{$EmployeeUserRole->name}}</div>
                                    <div class="row">: {{$EmployeeUserRole->display_name}}</div>
                                    <div class="row">: {{$EmployeeUserRole->shift_time}}</div>
                                    <div class="row">: {{$EmployeeUserRole->day}}</div>
                                </div>
                                <div class="row">
                                    <form action="{{route('shift.destroy',$EmployeeUserRole->id)}}" method="post">
                                        <a href="{{route('shift.edit',$EmployeeUserRole->id)}}" class="btn ps-0" style="color:#1351d6">
