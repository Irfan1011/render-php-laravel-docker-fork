                ...
                <div class="container justify-content-md-center mb-4">
                    <div class="row">
                        <div class="col col-8 mt-2">
                            <form>
                                <a href="{{route('mitra.create')}}" class="btn btn-primary btn-sm mt-2 mb-4 text-white fw-bold" style="color:#ebff0d"><i class="fa fa-plus fw-bold"> Rental My Car</i></a>
                            </form>
                        </div>
                        <div class="col p-0">
                            <form action="{{ route('searchMitra') }}" method="GET">
                        ...
                        <tr>
                            <td class="text-center" colspan="2">
                                <form action="{{route('mitra.destroy',$Mitra->id)}}" method="post">
                                    <a href="{{route('mitra.edit',$Mitra->id)}}" class="btn" style="color:#1351d6">
